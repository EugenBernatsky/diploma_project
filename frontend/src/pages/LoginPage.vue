...
async function handleSubmit() {
  ...
  if (!username.value.trim() || !password.value.trim()) {
    errorText.value = 'Please fill in both username and password.'
    return
  }
  ...
  <section class="auth-page">
    <div class="auth-page__card">
      <div class="auth-page__copy">
        ...
        <h1 class="auth-page__title">Log in to MediaCompass</h1>
        <p class="auth-page__text">
          Continue exploring your catalog, recommendations, and community activity.
        </p>
      </div>
